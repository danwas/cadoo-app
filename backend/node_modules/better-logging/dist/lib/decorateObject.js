...
exports.decorateObject = (target, implementation, config) => {
    ...
    const funcFactory = (type) => (msg, ...args) => {
        const [message, remainingArgs] = formatMessage_1.formatMessage(type, config, [msg, ...args]);
        if (config.saveToFile !== null) {
            writeToFile_1.writeLogToFile(config.saveToFile, message, remainingArgs);
        }
